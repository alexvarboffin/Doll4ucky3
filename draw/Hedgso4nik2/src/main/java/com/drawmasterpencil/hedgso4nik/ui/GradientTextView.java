package com.drawmasterpencil.hedgso4nik.ui;
...
public class GradientTextView extends AppCompatTextView {
    ...
    private static final int COLOR_1 = Color.parseColor("#FF6D00");
    private static final int COLOR_2 = Color.parseColor("#FFAB00");
