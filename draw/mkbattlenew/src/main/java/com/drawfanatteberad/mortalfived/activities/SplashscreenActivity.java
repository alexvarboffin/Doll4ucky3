...
import static com.drawfanatteberad.mortalfived.utlis.AppConstants.PREF_NUMBER_OF_STARTS;
...
import com.drawfanatteberad.mortalfived.databinding.ActivitySplashscreenBinding;
...
public class SplashscreenActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        //binding.tvAppMotto.animate().scaleXBy(2.f).scaleYBy(2.f).setDuration(500L).start();
