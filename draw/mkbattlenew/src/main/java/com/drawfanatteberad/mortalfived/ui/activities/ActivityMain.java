package com.drawfanatteberad.mortalfived.ui.activities;

import static com.drawfanatteberad.mortalfived.utlis.AppConstants.EXTRA_SHOW_RATE_US_DIALOG;
...
import com.drawfanatteberad.mortalfived.databinding.ActivityMainBinding;
...
public class ActivityMain extends BaseActivity
    ...
    private void initViews() {
        ...
        //ImageButton rate = findViewById(R.id.action_rate_app);
        //rate.setOnClickListener(v -> Utils.openAppOnPlayMarket(ActivityMain.this));

        tvAllApps.setOnClickListener(v -> openDeveloperPageOnPlayMarket());
...
//              .setConsentDebugSettings(debugSettings)
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_rate:
                Utils.openAppOnPlayMarket(this);
                break;
    ...
    private void showRateAppDialog() {
        ...
        alertDialog.setPositiveButton(getString(R.string.rate_us),
                (dialog, which) -> Utils.openAppOnPlayMarket(ActivityMain.this));
